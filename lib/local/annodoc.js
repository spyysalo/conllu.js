...
//         		      function(a, b) { return b.replace(/\s+/g, ' '); });
    ...
    var parseSd = function(sd, log) {
        ...
        for (var i=0; i<tokens.length; i++) {
            var text_POS = parseSdToken(tokens[i]);
    ...
    var parseConllX = function(conll, log) {
        ...
        conll = normalizeSpace(conll); // TODO: reconsider using this
...
//                    '</span></span>';
    ...
    var embedAnnotation = function(elem, parse, cdata, data, options) {
        ...
        // initialize parse function, falling back to .ann standoff as
        // default
        if (parse === undefined) {
            parse = parseAnn;
        }
